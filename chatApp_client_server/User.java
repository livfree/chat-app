	...
	public static void main(String[] args) {
		...
		try {
		      ...
		      String message = inputLine.readLine();
                      //make sure user input starts with #status string
                      if (message.startsWith("#status")) {
                           output_stream.println(message);
                       }
                      String messageFromServer = input_stream.readLine();
                      if (messageFromServer.startsWith("#statusPosted")){
			...
			userSocket.close();
                          ...
                          System.out.println("status was never posted");
                   }
		} catch (IOException e) {
